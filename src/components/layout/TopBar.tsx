const PHONE = "+225 07 47 26 48 92";
const EMAIL = "sciencesaufeminin@gmail.com";
  ...
  return (
    <div className="bg-stf-orange px-4 py-2 text-xs font-medium text-white sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl items-center gap-5">
        <a href={`tel:${PHONE.replace(/\s+/g, "")}`} className="flex items-center gap-1.5 transition-opacity hover:opacity-80">
