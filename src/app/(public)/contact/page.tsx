    ...
    <>
      ...
      <section className="py-20">
        <Container className="grid gap-10 lg:grid-cols-[1fr_1.4fr]">
          ...
          <form className="space-y-5 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm sm:p-8">
            <div className="grid gap-5 sm:grid-cols-2">
              <div>
                <label className="text-sm font-semibold text-stf-navy">Nom complet</label>
                <input
                  type="text"
                  required
            ...
            <div>
              <label className="text-sm font-semibold text-stf-navy">Sujet</label>
              <input
                type="text"
                required
                className="mt-2 w-full rounded-xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-stf-blue"
            ...
            <div>
              <label className="text-sm font-semibold text-stf-navy">Message</label>
              <textarea
                required
                rows={5}
                className="mt-2 w-full rounded-xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-stf-blue"
