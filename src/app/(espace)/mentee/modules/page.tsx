        ...
        {menteeModules.map((m) => (
          ...
          >
            ...
            <div className="mt-4">
              ...
              <p className="mt-2 text-xs text-slate-400 dark:text-slate-500">{m.progress}% complété</p>
            </div>
            <button className="mt-4 w-full rounded-full border border-stf-blue px-4 py-2.5 text-sm font-semibold text-stf-blue hover:bg-stf-blue-light dark:hover:bg-stf-blue/15">
