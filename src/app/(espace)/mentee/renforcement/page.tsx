...
import { updateCourseProgressAction } from "@/lib/actions/renforcement";
import type { CourseWithProgress } from "@/lib/types";

export default async function MenteeRenforcementPage() {
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between">
                <h2 className="font-semibold text-stf-navy dark:text-white">{c.title}</h2>
              ...
              {progress < 100 ? (
                <form action={updateCourseProgressAction.bind(null, c.id, nextProgress)}>
                  <button
                    type="submit"
